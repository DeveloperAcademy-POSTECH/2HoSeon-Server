...
public class PostCommentInfoDTO {
    ...
    List<PostCommentInfoDTO> childComments;

    public void setChildComments(List<PostCommentInfoDTO> childComments) {
        this.childComments = childComments;
    }

    public PostCommentInfoDTO(Long commentId, LocalDateTime createDate, LocalDateTime modifiedDate, String content, AuthorInfoDTO author) {
